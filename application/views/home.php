...
Our Service
  ...
  <div class="our_services">
    ...
    <br >
    <a href="<?=site_url("sales_marketing") ?>">
    <div id="" align="middle">
    ...
    <br />
    <a href="<?=site_url("Accounting_Consultancy") ?>">
...
<div class="footer">
  <div><footer><p>Coded by <a href="httsthenewbreedtechnologies.com/">NBT</a></p>
  <img class="facebook" src="<?=base_url("assert/images/facebook.jpg")?>" width="70%"><br />
  <img class="twitter" src="<?=base_url("assert/images/twitter.jpg")?>" width="70%"><br />
  <img class="gmail" src="<?=base_url("assert/images/gmail .jpg")?>" width="70%"><br />
</div>
<div  id="" align= "middle" display: flex;
    justify-content: space-between;>
  <span><em> About_Us</em></span>

  <span> <em>Contact_Us</em></span>
  </div>
</div>
